          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-24">
            ...
            >
              ...
              <div className="space-y-6">
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    ...
                    <p className="text-foreground/70 leading-relaxed">
                      {t("footer.address").split(', ').map((line, i) => <span key={i}>{line}{i < t("footer.address").split(', ').length - 1 && ', '}</span>)}
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    ...
                    <p className="text-foreground/70 leading-relaxed flex flex-col">
              ...
              <div className="pt-6 border-t border-border">
                <h3 className="font-semibold text-lg mb-4">{t("contact.connect")}</h3>
                <Button size="lg" className="bg-[#25D366] text-white hover:bg-[#20bd5a] w-full sm:w-auto" asChild>
            ...
            >
              ...
              {isSubmitted ? (
                <div className="bg-green-500/10 text-green-600 p-6 rounded-xl border border-green-500/20 text-center space-y-4">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                  <div>
                    ...
                    <input 
                      id="name"
                      type="text" 
                      className={`w-full px-4 py-3 rounded-lg border bg-background focus:outline-none focus:ring-2 focus:ring-secondary/50 ${errors.name ? 'border-red-500' : 'border-border'}`}
                  ...
                  <div>
                    <label htmlFor="phone" className="block text-sm font-medium mb-2">{t("contact.form.phone")}</label>
                    <input 
                      id="phone"
                      type="tel" 
                      className={`w-full px-4 py-3 rounded-lg border bg-background focus:outline-none focus:ring-2 focus:ring-secondary/50 ${errors.phone ? 'border-red-500' : 'border-border'}`}
                  ...
                  <div>
                    <label htmlFor="course" className="block text-sm font-medium mb-2">{t("contact.form.course")}</label>
                    <select 
                      id="course"
                      className={`w-full px-4 py-3 rounded-lg border bg-background focus:outline-none focus:ring-2 focus:ring-secondary/50 ${errors.course ? 'border-red-500' : 'border-border'}`}
                  ...
                  <div>
                    <label htmlFor="message" className="block text-sm font-medium mb-2">{t("contact.form.msg")}</label>
                    <textarea 
                      id="message"
                      rows={4}
                      className={`w-full px-4 py-3 rounded-lg border bg-background focus:outline-none focus:ring-2 focus:ring-secondary/50 resize-none ${errors.message ? 'border-red-500' : 'border-border'}`}
