      ...
      <div className="flex-1 flex items-center justify-center p-4">
        ...
        >
          <div className="text-center mb-8">
            <h1 className="text-2xl font-bold text-primary mb-2">Student Portal</h1>
          ...
          <form action={formAction} className="space-y-5">
            ...
            <div>
              <label className="block text-sm font-medium mb-2 text-foreground/80">Student ID / Email</label>
